/**
 * @file types/botilito.ts
 * @description Centralized type definitions for the Botilito application.
 * These types are inspired by the OpenAPI specification from the figma-design prototype
 * to ensure consistency with the target backend structure.
 */
