...
import {
    ...
    Heart, Smile, ArrowLeft, Newspaper, Tag, ExternalLink, User, Clock, Send, ChevronDown, Loader2
} from 'lucide-react';
...
export function HumanVerificationDetail({ caseData, onBackToList, onSubmit, isSubmitting = false }: HumanVerificationDetailProps) {
                ...
                <CardContent className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <Badge variant={caseData.consensus?.state === 'consensus' ? 'default' : 'secondary'}>{caseData.consensus?.state}</Badge>
                            </div>
                        </div>
                        <Collapsible>
                    ...
                    <div className="flex justify-end">
                        <Button onClick={handleInternalSubmit} disabled={marcadoresDiagnostico.length === 0 || isSubmitting} size="lg">
                            ...
                            {isSubmitting ? 'Enviando...' : 'Enviar Diagnóstico Humano'}
                        </Button>
                    </div>
                </CardContent>
            </Card>
