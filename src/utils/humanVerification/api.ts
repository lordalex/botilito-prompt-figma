...
import { getEvaluationFromInsights } from '@/types/validation';
...
export function transformStandardizedToEnriched(std: any): CaseEnriched {
  ...
  return {
    ...
    metadata: {
      ...
      amiLevel: getEvaluationFromInsights(std.type, std.overview, std.insights), // AMI compliance level badge or Forensic Verdict
      ...std.metadata
    },
